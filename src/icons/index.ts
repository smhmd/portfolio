...
export { default as ArrowLeft } from '@material-icons/svg/svg/chevron_left/round.svg?react'
export { default as ArrowRight } from '@material-icons/svg/svg/chevron_right/round.svg?react'
export { default as Circle } from '@material-icons/svg/svg/circle/round.svg?react'
